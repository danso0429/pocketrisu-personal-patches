...
| Early-send and normal chat-open adoption | Pure client classifiers, read-only pending component | Admission/response classifiers and pending display exist; no ordinary input-v1 caller or chat adoption is active. |
