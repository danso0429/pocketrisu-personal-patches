...
| [Haejeok RisuAI](https://github.com/nevaeh5379/HaejeokRisuai) | `e9d035683cdf9f0207eed193ee36f9bdb117f658` / `b6254` | HJ04 adapts focused message/plugin persistence ordering from `0fd90fcf`, `23bb7437`, `313ecdff`, and `3b5b3d39`. HJ03 adapts Korean character matching from `86ee613c` and `1e5f9eee`. HJ01 adapts the missing Small 600px chat-width outcome from `0243d078`. SQL/domain storage, object storage/explorer, low-spec paging, server compute, ZIP64 streaming, other layout controls, and operational backup were compared as references. | GPL-3.0. HJ04 uses PocketRisu lazy-chat/BG storage; HJ03 keeps native catalog order; HJ01 extends the existing native Standard-width setting instead of adding Haejeok's competing database field. Exact paths, dependency notice, and exclusions are in `THIRD_PARTY_NOTICES.md`; the broader comparison is in `HAEJEOK-RISUAI-OVERLAP-AUDIT.md`. |
