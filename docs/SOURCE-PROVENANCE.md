...
| [Haejeok RisuAI](https://github.com/nevaeh5379/HaejeokRisuai) | `e9d035683cdf9f0207eed193ee36f9bdb117f658` / `b6254` | The focused message/plugin persistence ordering from commits `0fd90fcf`, `23bb7437`, `313ecdff`, and `3b5b3d39` is adapted by the internal HJ04 patcher payload. Its SQL/domain storage, object storage/explorer, low-spec paging, server compute, ZIP64 streaming, Korean search, layout controls, and operational backup were also compared as references. | GPL-3.0. HJ04 is rebuilt around PocketRisu lazy-chat/BG storage rather than copying Haejeok SQL stores. Exact paths and exclusions are in `THIRD_PARTY_NOTICES.md`; the broader comparison is in `HAEJEOK-RISUAI-OVERLAP-AUDIT.md`. |
