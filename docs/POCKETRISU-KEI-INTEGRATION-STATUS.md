...
| 4. K15 partial edit, K11 Hypa tools, K12 translation tools | Next: K15 | Implement and validate one feature at a time; editing/cache/generation ownership remains controlling |
...
K19, K13, K14, and K16 are the Kei feature implementations presently in the candidate.
Excluded/deferred rows and policy-pack designs are catalog decisions, not
implemented progress.

## Current review and publication boundary

1. Keep the foundation, K19, verifier, K13, K14, K16, and documentation
...
### K15 — partial message editing

K13, K14, and K16 automated boundaries are recorded. Next, qualify the
intended-message resolution and shared edit listener with separate base and
bg-preserve adapters. Resolve the target message once, cancel stale targets,
and prevent translation-cache writes from crossing message identity. Preserve
bg-preserve generation delivery and cancellation rather than introducing a
parallel edit/generation authority.

After K15, continue with K11 and K12, then admission steps 5–7 in catalog
