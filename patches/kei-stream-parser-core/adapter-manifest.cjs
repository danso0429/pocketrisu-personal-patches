...
const adapter = 'bg'
const snippet = (name) => read(snippetsRoot, name)
    .replaceAll('{{ADAPTER}}', adapter)

function createStreamAdapterManifest({ id, title }) {
    ...
    return {
        ...
        requires: ['kei-stream-parser-core', 'bg-preserve'],
        autoWhen: {
        ...
        units: [
            {
                ...
                managed: snippet('openai-import.ts'),
            ...
            },
            {
                ...
                managed: snippet('openai-function.ts'),
            ...
            },
            {
                ...
                where: 'after',
                anchor: "import type { RequestDataArgumentExtended, requestDataResponse, StreamResponseChunk } from './request'\n",
                managed: snippet('google-import.ts'),
            ...
            },
            {
                ...
                managed: snippet('google-function.ts'),
