...
const globalOwners = [
    ...
    "lazy-chat-bg-adapter:browser-stat-effect-import:1.10",
    "lazy-chat-bg-adapter:browser-stat-effect-rebase:1.10",
...
const storageOwners = [
    ...
    "lazy-chat-bg-adapter:server-chat-snapshot-type:1.10",
...
const chatOwners = [
    ...
    "lazy-chat-bg-adapter:server-pending-ui-import:1.10",
    "lazy-chat-bg-adapter:server-pending-ui-selection:1.10",
    "lazy-chat-bg-adapter:server-pending-ui-render:1.10",
    "lazy-chat-bg-adapter:server-input-client-send:1.10",
    "lazy-chat-bg-adapter:server-input-client-busy-ui:1.10",
    "lazy-chat-bg-adapter:composer-draft-identity-state:1.10",
    "lazy-chat-bg-adapter:composer-draft-identity-reset:1.10",
    "lazy-chat-bg-adapter:composer-draft-identity-load:1.10",
    "lazy-chat-bg-adapter:composer-draft-identity-persist:1.10",
    "lazy-chat-bg-adapter:composer-draft-identity-cleanup:1.10",
    "lazy-chat-bg-adapter:composer-draft-identity-save:1.10",
