...
`,
    ...
    },
    {
        ...
        personalAppearanceChatFont: "Applies Paperlogy only to message bodies. Code, keyboard input, and samples keep a monospace stack. Paperlogy is a new opt-in look, not a migration of the previously invalid CSS declaration.",
...
`,
    ...
    },
    {
        ...
        "personalAppearanceChatFont": "메시지 본문에만 Paperlogy를 적용해요. 코드·키보드 입력·샘플은 고정폭 폰트를 유지해요. 기존의 무효 CSS를 옮기는 것이 아니라 새 외형을 선택하는 기능이에요.",
